...
//        initializeLeftPanel(jpanel);
//        initializeRightPanel(jpanel);
//        initializeBottomPanel(jpanel);
//       
//        
//        myFrame.setVisible(true);
    ...
    public static class MyWindow extends JFrame{
        ...
        // Override the default method definition in Window class
        @Override
    ...
    public static void initializeMenu(JFrame myFrame){
    ...
    public static void initializeLeftPanel(Panel jpanel){
...
//        checkboxPanel.setBackground(new Color(255,255,255,0));
        ...
        jpanel.add(leftPanel, c);
        
        
    }
    
    public static void initializeRightPanel(Panel jpanel){
...
//        c.anchor = GridBagConstraints.FIRST_LINE_START;
    ...
    public static void initializeBottomPanel(Panel jpanel){
